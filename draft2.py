...
# Insert all 4 variables (incl. ImageFile)
insert_img1 = """
...
os.chdir(r"C:\Data\Programming\Programs\Python\Image Organizer")    # GENERALIZE
parent_dir = os.getcwd()

imgDirectory_str = r"C:\Data\Programming\Programs\Python\Image Organizer\images"   # GENERALIZE 
...
for roots, directories, files in imgDirectory:
    ...
    for file in files:
        ...
        # Conver the image to bytes for the SQL database
        ...
        # print(md5hash)
        input_hash = md5hash
        sql_query = pd.read_sql_query(select_hash.format(input_hash), connection)    # Get dataframe of images that match the given input hash
        print("sql query")
        print((sql_query))
        ...
        if sql_query[''][0] == 0:
            ...
            cursor.execute(insert_img1, (file, imgDirectory_str, input_hash, imgBytes))   # Insert image with all four vars (incl )
